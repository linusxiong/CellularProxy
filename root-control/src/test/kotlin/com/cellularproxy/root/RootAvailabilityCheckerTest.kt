    ...
    fun `successful uid zero check reports root available`() {
        ...
        val checker =
            RootAvailabilityChecker(
                executor =
                    rootAvailabilityExecutor(calls) {
            ...
            RootCommandExecution.completed(
                ...
                started =
                    com.cellularproxy.shared.root.RootCommandAuditRecord
                        .started(RootCommandCategory.RootAvailabilityCheck),
                completed =
                    com.cellularproxy.shared.root.RootCommandAuditRecord.completed(
                        com.cellularproxy.shared.root.RootCommandResult.completed(
                            category = RootCommandCategory.RootAvailabilityCheck,
                            exitCode = 0,
                            stdout = "0",
