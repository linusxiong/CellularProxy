...
object CloudflareTunnelStateMachine {
    ...
    private fun accepted(status: CloudflareTunnelStatus): CloudflareTunnelTransitionResult = CloudflareTunnelTransitionResult(CloudflareTunnelTransitionDisposition.Accepted, status)

    private fun duplicate(status: CloudflareTunnelStatus): CloudflareTunnelTransitionResult = CloudflareTunnelTransitionResult(CloudflareTunnelTransitionDisposition.Duplicate, status)

    private fun ignored(status: CloudflareTunnelStatus): CloudflareTunnelTransitionResult = CloudflareTunnelTransitionResult(CloudflareTunnelTransitionDisposition.Ignored, status)
}
