...
private fun HttpProxyOutboundExchangeHandlingResult.clientBytesReceived(): Long =
    when (this) {
...
private fun HttpProxyOutboundExchangeHandlingResult.clientBytesSent(): Long =
    when (this) {
...
private fun HttpProxyStreamExchangeForwardingResult.clientBytesReceived(): Long =
    when (this) {
...
private fun HttpProxyStreamExchangeForwardingResult.clientBytesSent(): Long =
    when (this) {
...
private fun HttpProxyRequestStreamForwardingResult.clientBytesReceived(): Long =
    when (this) {
...
private fun HttpProxyResponseStreamForwardingResult.clientBytesSent(): Long =
    when (this) {
...
private fun ConnectTunnelOutboundExchangeRelayHandlingResult.clientBytesReceived(): Long =
    when (this) {
...
private fun ConnectTunnelOutboundExchangeRelayHandlingResult.clientBytesSent(): Long =
    when (this) {
        is ConnectTunnelOutboundExchangeRelayHandlingResult.Relayed ->
...
private fun ManagementApiStreamExchangeHandlingResult.clientBytesSent(): Long =
    when (this) {
...
private fun ConnectTunnelBidirectionalRelayResult.clientToOriginBytesRelayed(): Long =
    bytesForDirection(ConnectTunnelRelayDirection.ClientToOrigin)
...
private fun HttpBodyStreamCopyResult.bytesCopied(): Long =
    when (this) {
