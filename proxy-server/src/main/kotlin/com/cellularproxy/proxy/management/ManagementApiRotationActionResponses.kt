...
object ManagementApiRotationActionResponses {
    fun transition(result: RotationTransitionResult): ManagementApiResponse = ManagementApiResponse.json(
...
private fun RotationTransitionDisposition.apiValue(): String = when (this) {
...
private fun RotationState.apiValue(): String = when (this) {
...
private fun RotationOperation.apiValue(): String = when (this) {
    RotationOperation.MobileData -> "mobile_data"
    RotationOperation.AirplaneMode -> "airplane_mode"
}

private fun RotationFailureReason.apiValue(): String = when (this) {
