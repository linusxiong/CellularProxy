...
class CloudflareE2eValidationConfigTest {
    ...
    fun `android instrumentation receives Cloudflare e2e arguments from local file environment or Gradle property sources`() {
        ...
        assertTrue(appBuild.contains(".gradleProperty(propertyName)"))
        assertTrue(appBuild.contains("localProperty = \"cellularproxy.cloudflareTunnelToken\""))
        assertTrue(appBuild.contains("localProperty = \"cellularproxy.cloudflareManagementHostname\""))
        assertTrue(appBuild.contains("localProperty = \"cellularproxy.managementApiToken\""))
        assertTrue(appBuild.contains("gradleProperty = \"cellularproxy.cloudflareTunnelToken\""))
        assertTrue(appBuild.contains("gradleProperty = \"cellularproxy.cloudflareManagementHostname\""))
        assertTrue(appBuild.contains("gradleProperty = \"cellularproxy.managementApiToken\""))
        assertTrue(appBuild.contains("localPropertyAlias = \"cellularproxy.e2e.cloudflareTunnelToken\""))
        assertTrue(appBuild.contains("localPropertyAlias = \"cellularproxy.e2e.cloudflareManagementHostname\""))
        assertTrue(appBuild.contains("localPropertyAlias = \"cellularproxy.e2e.cloudflareManagementApiToken\""))
        assertTrue(appBuild.contains("gradlePropertyAlias = \"cellularproxy.e2e.cloudflareTunnelToken\""))
        assertTrue(appBuild.contains("gradlePropertyAlias = \"cellularproxy.e2e.cloudflareManagementHostname\""))
        assertTrue(appBuild.contains("gradlePropertyAlias = \"cellularproxy.e2e.cloudflareManagementApiToken\""))
